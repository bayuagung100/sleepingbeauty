...
<body class="animsition">
    ...
    <header <?php if ($content=="home") {} else {echo'class="header-v4"';} ?>>
        <!-- Header desktop -->
        <div class="container-menu-desktop">
            ...
            <div <?php if ($content=="home") {echo'class="wrap-menu-desktop"';} else {echo'class="wrap-menu-desktop how-shadow1"';} ?>>
                <nav class="limiter-menu-desktop container">

                    <!-- Logo desktop -->
                    <a href="<?php echo $set['url'];?>" class="logo">
                        <img src="<?php echo $set['url'];?>images/logo.png" alt="Logo">
                    </a>
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li <?php if ($content=="home") {echo'class="active-menu"';} else {} ?>>
                                <a href="<?php echo $set['url'];?>">Home</a>
                            </li>

                            <li <?php if ($content=="product") {echo'class="active-menu"';} else {} ?>>
                            ...
                            <li <?php if ($content=="best-seller") {echo'class="active-menu label1"';} else {echo 'class="label1"';} ?> data-label1="hot">
                                <a href="<?php echo $set['url'];?>best-seller">Best Seller</a>
                            </li>

                            <li <?php if ($content=="contact") {echo'class="active-menu"';} else {} ?>>
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="<?php echo $set['url'];?>"><img src="<?php echo $set['url'];?>images/logo.png" alt="Logo"></a>
            </div>
            ...
            <div class="header-cart-content flex-w js-pscroll">
                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        <a href="<?php echo $set['url']; ?>cart" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
                            View Cart / CheckOut
                        </a>
                    </div>
                </div>
